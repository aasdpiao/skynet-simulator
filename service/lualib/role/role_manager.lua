...
function RoleManager:load_sign_in()
    local sign_box_config = sharedata.deepcopy "sign_box_config"
    local sign_in_config = sharedata.deepcopy "sign_in_config"
...
function RoleManager:load_speedup_config()
    local speedup_config = sharedata.deepcopy "speedup_config"
...
function RoleManager:load_role_config()
    local levelup_config = sharedata.deepcopy "levelup_config"
